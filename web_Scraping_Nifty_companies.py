...
def Nifty_companies():
    ...
    driver.get("https://www.equitymaster.com/india-markets/nse-replica.asp")
    ...
    df.to_csv("Nifty_companies.csv", index=None)
